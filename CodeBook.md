...
This is a code book that describes the variables, the data, and any transformations or work that analyst performed to clean up the data.
...
Data were transformed in 5 steps:
...
* Process the data -  test and train datasets.
* Merge data sets.
